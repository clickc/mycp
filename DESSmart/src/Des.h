...
public:
	...
	bool	Encrypt(FILE &fh_out,FILE &fh_in,const char *KeyStr,const char *OutFile,const char *InFile);//加密
	bool	Decrypt(FILE &fh_out,FILE &fh_in,const char *KeyStr,const char *OutFile,const char *InFile);//解密
