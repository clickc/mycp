...
./svm_multiclass_learn.exe -c 5000 example4/train_format.txt example4/model
#./svm_multiclass_classify.exe example4/test_format.txt example4/model example4/predictions >> log.txt
