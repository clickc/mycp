...
/**
 * one layer specially designed to process multiple inputs
 * 
 * inputs may include:
 *    origin data point
 *    gradient of every data point
 *    normalized data point
 *    etc
 *    
 * also may include features from other sources for every point
 *    
 * @author blue
 */
public class MultiInputBlockLayer extends Layer{
	...
	// origin data point
	public SeqBufferDouble originInputActivations;
    public SeqBufferDouble originInputErrors;
	
	// gradient of every data point
    // we will induce it from originInput in this class 
	public SeqBufferDouble gradientInputActivations;
    public SeqBufferDouble gradientInputErrors;
    
    // normalized data point
    // we will induce it from originInput in this class
 	public SeqBufferDouble normalizedInputActivations;
    public SeqBufferDouble normalizedInputErrors;
	 ...
	 * @param src
	 */
	public MultiInputBlockLayer(String name, int numSeqDims, int inputSize, int outputSize, Layer src) {
		super(name, numSeqDims, inputSize, outputSize, src);		
	}
	
	
	public MultiInputBlockLayer(Layer src, Vector<Integer> blockShape){
		...
		//although link layers but have no parameters
