...
typedef struct
{
    double **class_word;
    	//******************************************************此解释应该不正确***********************************************************************************
	//此**class_word充分统计量不同于Gibbs版的(主题,单词)充分统计量，在Gibbs版的(主题,单词)充分统计量中，第二维度全局单词表的长度，
	//在这里计算**var_gamma, //**phi的后验概率是逐个文档进行的，所以充分统计量也具体到每篇文档，所以在这里**class_word第二维度是该文档中单词的个数(不重复)
	//*******************************************************更正如下*******************************************************************************
	//此**class_word充分统计量和Gibbs版的(主题,单词)充分统计量一样，第一维是主题，第二维是单词，(i,j)元素指第j个单词在主题i中的概率
    double *class_total;
